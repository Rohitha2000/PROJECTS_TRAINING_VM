...
public class IrctcController {
	...
	public String showTicketBookingForm(@ModelAttribute("ticketBooking1") TicketBooking ticketBook) throws ApplicationException {
		...
		System.out.println("entered 1st method controll");
		ModelAndView modelAndView = new ModelAndView();    
		//modelAndView.setViewName("ticketBooking1");  
		modelAndView.addObject("ticketBooking1", ticketBook);  
	...
	{
		System.out.println("entered above result condition");
		if(result.hasErrors())
		{System.out.println("entered result method");
		return "ticketBooking";
		}
